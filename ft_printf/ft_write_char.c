...
/*   Updated: 2021/01/21 18:13:12 by hkikuchi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void	write_left_justified(int min_field, char c)
{
	int	j;
...
static void	fill_zero(int min_field, char c)
{
	int	j;
...
static void	fill_blanc(int min_field, char c)
{
	int	j;
