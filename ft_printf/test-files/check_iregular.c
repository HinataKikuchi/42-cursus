...
int main(void)
{
	...
	printf("[%%.3u]=[%.3u]\n",u);
	ft_printf("\nu = 0\n");
	ft_printf("[%%10.3u]=[%10.3u]\n",u);
	ft_printf("[%%3.10u]=[%3.10u]\n",u);
	ft_printf("[%%10.u]=[%10.u]\n",u);
	ft_printf("[%%3.u]=[%3.u]\n",u);
	ft_printf("[%%.10u]=[%.10u]\n",u);
	ft_printf("[%%.3u]=[%.3u]\n",u);
	...
	printf("[%%.3x]=[%.3x]\n",x);
	ft_printf("\nx = 0\n");
	ft_printf("[%%10.3x]=[%10.3x]\n",x);
	ft_printf("[%%3.10x]=[%3.10x]\n",x);
	ft_printf("[%%10.x]=[%10.x]\n",x);
	ft_printf("[%%3.x]=[%3.x]\n",x);
	ft_printf("[%%.10x]=[%.10x]\n",x);
	ft_printf("[%%.3x]=[%.3x]\n",x);
	...
	printf("[%%.3c]=[%.3c]\n",c);
	ft_printf("\nc = 0\n");
	ft_printf("[%%10.3c]=[%10.3c]\n",c);
	ft_printf("[%%3.10c]=[%3.10c]\n",c);
	ft_printf("[%%10.c]=[%10.c]\n",c);
	ft_printf("[%%3.c]=[%3.c]\n",c);
	ft_printf("[%%.10c]=[%.10c]\n",c);
	ft_printf("[%%.3c]=[%.3c]\n",c);
	...
	printf("[%%.3p]=[%.3p]\n",p);
	ft_printf("\np = NULL\n");
	ft_printf("[%%10.3p]=[%10.3p]\n",p);
	ft_printf("[%%3.10p]=[%3.10p]\n",p);
	ft_printf("[%%10.p]=[%10.p]\n",p);
	ft_printf("[%%3.p]=[%3.p]\n",p);
	ft_printf("[%%.10p]=[%.10p]\n",p);
	ft_printf("[%%.3p]=[%.3p]\n",p);
